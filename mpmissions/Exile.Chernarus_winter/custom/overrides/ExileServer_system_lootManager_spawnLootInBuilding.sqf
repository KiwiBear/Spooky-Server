			...
			switch (_cargoType) do
			{
				...
				{ 
					...
					if !(_itemClassName isKindOf ["Exile_Melee_Abstract", configFile >> "CfgWeapons"]) then
					{
						...
						{
							_magazineClassNames = _magazineClassNames - _badAmmo;
