...
*/
_himage = 0;
if (_health >= 90)			           then { _himage = 4 };
if (_health >= 70 && _health < 90)		   then { _himage = 3 };
if (_health >= 50 && _health < 70)	   	   then { _himage = 2 };
if (_health >= 30 && _health < 40)		   then { _himage = 1 };
if (_health < 10)			               then { _himage = 0 };
